...
export default function Sidebar({ open, onClose, onProjectClick, onSettingsClick, onReminderSettingsClick, projectsRefreshKey, activeProjectId }: SidebarProps) {
      ...
      >
        ...
        <div className="border-t border-zinc-800 pt-3 space-y-0.5">
          ...
          {onReminderSettingsClick && (
            <button
              onClick={() => { onReminderSettingsClick(); onClose(); }}
              className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-zinc-500 hover:bg-zinc-800/60 hover:text-zinc-300 transition"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round">
